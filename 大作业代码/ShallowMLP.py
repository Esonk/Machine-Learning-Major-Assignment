...
def main() -> None:
    ...
    model = ShallowMLP(input_dim=len(FEATURE_COLUMNS), num_classes=2)
    result = train_one_model("ShallowMLP", model, split_data, results_dir, device)
    metrics = result["test_metrics"]
    print("ShallowMLP test metrics")
