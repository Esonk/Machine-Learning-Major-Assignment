...
def main() -> None:
    ...
    model = FeatureCNN1D(input_dim=len(FEATURE_COLUMNS), num_classes=2)
    result = train_one_model("FeatureCNN1D", model, split_data, results_dir, device)
    metrics = result["test_metrics"]
    print("FeatureCNN1D test metrics")
